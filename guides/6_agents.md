# Building Siro: Part 6 - AI Agent Orchestra

Welcome to the most exciting part of Siro! In this guide, you'll deploy a sophisticated multi-agent AI system where specialized agents collaborate to provide comprehensive financial analysis. This is where Siro truly comes to life as an intelligent financial advisor.
...
vector_bucket = "siro-vectors-123456789012"  # Replace with your account ID
...
Outputs:
lambda_functions = {
  "charter" = "siro-charter"
  "planner" = "siro-planner"
  "reporter" = "siro-reporter"
  "retirement" = "siro-retirement"
  "tagger" = "siro-tagger"
}
...
**Expected output**:
```
Updating siro-tagger... ✅
Updating siro-reporter... ✅
Updating siro-charter... ✅
Updating siro-retirement... ✅
Updating siro-planner... ✅
...
2. You'll see 5 functions: `siro-planner`, `siro-tagger`, `siro-reporter`, `siro-charter`, `siro-retirement`
3. Click on `siro-planner`
...
5. Check the dead letter queue `siro-analysis-jobs-dlq` (should be empty)
