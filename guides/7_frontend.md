# Building Siro: Part 7 - Frontend & API

Welcome to the final development phase! In this guide, you'll deploy the user interface that brings Siro to life - a modern React application with real-time agent visualization, portfolio management, and comprehensive financial analysis displays.
...
```bash
# In your siro directory root .env file, add:
...
# Go to siro/scripts in your terminal
...
1. **Landing Page**: You'll see the Siro AI Financial Advisor homepage
...
```bash
# Go to siro/terraform/7_frontend directory
...
```bash
# In siro/terraform/7_frontend directory
...
# In siro/terraform/6_agents directory
terraform output sqs_queue_url

# Add to your .env file:
SQS_QUEUE_URL=https://sqs.us-east-1.amazonaws.com/123456789012/siro-analysis-jobs
```
...
# In siro/terraform/5_database directory
terraform destroy
...
Your Siro Financial Advisor is now live and ready for users! 🎉
...
# View logs
aws logs tail /aws/lambda/siro-api --follow
```
...
Excellent work completing the Siro Financial Advisor! 🚀