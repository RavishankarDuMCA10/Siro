# Siro Architecture Overview (S3 Vectors Version)

## System Architecture

The Siro platform uses a modern serverless architecture on AWS, combining AI services with cost-effective infrastructure:
...
graph TB
    ...
    %% Backend Services
    Lambda[fa:fa-bolt Lambda<br/>siro-ingest<br/>Document Processing]
    AppRunner[fa:fa-server App Runner<br/>siro-researcher<br/>AI Agent Service]
    
    %% Scheduler Components
    EventBridge[fa:fa-clock EventBridge<br/>Scheduler<br/>Every 2 Hours]
    SchedulerLambda[fa:fa-bolt Lambda<br/>siro-scheduler<br/>Trigger Research]
...
### 3. **Lambda Functions**
- **siro-ingest**: Processes documents and stores embeddings
  - Runtime: Python 3.12
  - Memory: 512MB
  - Timeout: 30 seconds
- **siro-scheduler**: Triggers automated research
  - Runtime: Python 3.11
  - Memory: 128MB
  - Timeout: 150 seconds
...
- **Rule**: siro-research-schedule
- **Schedule**: Every 2 hours
- **Target**: siro-scheduler Lambda
