...
In this guide, you'll deploy the Siro Researcher service - an AI agent that generates investment research and automatically stores it in your knowledge base.
...
Here's how it fits into the Siro architecture:
...
- `SIRO_API_ENDPOINT` - From Part 3
- `SIRO_API_KEY` - From Part 3
...
siro_api_endpoint = "https://xxxxxxxxxx.execute-api.us-east-1.amazonaws.com/prod/ingest"  # From Part 3
siro_api_key = "your-api-key-here"  # From Part 3
...
```json
{
  "service": "Siro Researcher",
  "status": "healthy",
  "siro_api_configured": true,
  "timestamp": "2025-..."
}
```
...
```bash
aws logs tail /aws/lambda/siro-research-scheduler --follow --region us-east-1
```

2. Check App Runner logs to see the actual research being performed:
```bash
aws logs tail /aws/apprunner/siro-researcher/*/application --follow --region us-east-1
```
...
# Part 3
VECTOR_BUCKET=siro-vectors-123456789012
SIRO_API_ENDPOINT=https://xxxxxxxxxx.execute-api.us-east-1.amazonaws.com/prod/ingest
SIRO_API_KEY=your-api-key-here
